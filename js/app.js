 ...
 */
    ...
    (() => {
        ...
        function rangeInit() {
            ...
            if (priceSlider) {
                ...
                priceSlider.noUiSlider.on("update", (function(values, handle) {
                    ...
                    inputs[handle].style.width = Math.round(values[handle]) / 8e4 + "px";
                }));
        ...
        function initSliders() {
            if (document.querySelector(".object__slider")) new core(".object__slider", {
                modules: [ Navigation, Manipulation ],
                allowTouchMove: false,
                speed: 1e3,
                spaceBetween: 20,
                slideClass: "object__slide",
                wrapperClass: "object__wrapper",
                navigation: {
                    prevEl: ".object__button-prev",
                    nextEl: ".object__button-next"
                },
                breakpoints: {
                    360: {
                        spaceBetween: 20,
            ...
            if (document.querySelector(".complex__slider-wrapper")) {
                const complexSliderSmall = new core(".complex__slider-small", {
                    modules: [ Navigation, Manipulation, Lazy, Grid ],
                    speed: 700,
                    slideClass: "complex__slider-small-slide",
                    wrapperClass: "complex__slider-small-wrapper",
                    preloadImages: false,
                    lazy: {
                        loadPrevNext: true
                    },
                    navigation: {
                        prevEl: ".complex__slider-arrow-prev",
                        nextEl: ".complex__slider-arrow-next"
                    },
                    breakpoints: {
                        768: {
                            slidesPerView: 2,
                ...
                new core(".complex__slider-big", {
                    modules: [ Navigation, Manipulation, Lazy, Thumb ],
                    speed: 1e3,
                    spaceBetween: 0,
                    slideClass: "complex__slider-big-slide",
                    wrapperClass: "complex__slider-big-wrapper",
                    preloadImages: false,
                    lazy: {
                        loadPrevNext: true
                    },
            ...
            if (document.querySelector(".apartament__slider-wrapper")) {
                const apartamentSliderSmall = new core(".apartament__slider-small", {
                    modules: [ Navigation, Manipulation, Lazy ],
                    speed: 700,
                    slidesPerView: 3,
                    spaceBetween: 20,
                    slideClass: "apartament__slider-small-slide",
                    wrapperClass: "apartament__slider-small-wrapper",
                    preloadImages: false,
                    lazy: {
                        loadPrevNext: true
                    },
                    direction: "vertical",
                    navigation: {
                        prevEl: ".apartament__slider-arrow-prev",
                        nextEl: ".apartament__slider-arrow-next"
                    }
                });
                new core(".apartament__slider-big", {
                    modules: [ Navigation, Manipulation, Lazy, Thumb, Pagination ],
                    speed: 1e3,
                    spaceBetween: 0,
                    slideClass: "apartament__slider-big-slide",
                    wrapperClass: "apartament__slider-big-wrapper",
                    preloadImages: false,
                    lazy: {
                        loadPrevNext: true
                    },
                    pagination: {
                        el: ".apartament__slider-pagination",
                        clickable: true
                    },
                    observeParents: true,
                    observeSlideChildren: true,
...
***************************************************************************** */
        ...
        da.init();
        const widget = document.querySelector(".widget-js");
        if (widget) widget.addEventListener("click", (function(e) {
            this.classList.toggle("widget-active");
        }));
        const filterButton = document.querySelectorAll(".filter-js"), sel = document.querySelectorAll(".select"), filterItem = document.querySelectorAll(".filter-js-item");
        if (filterButton) {
            sel.forEach((el => {
                el.addEventListener("click", (function(e) {
                    if (!this.closest(".filter__item").classList.contains("filter-open")) filterItem.forEach((element => {
            ...
            filterButton.forEach((el => {
                el.addEventListener("click", (function(e) {
                    if (!this.closest(".filter-js-item").classList.contains("filter-open")) {
                        filterItem.forEach((element => {
                            element.classList.remove("filter-open");
                            element.querySelector(".dropdown-filter").setAttribute("hidden", "true");
                        }));
                        this.closest(".filter-js-item").classList.add("filter-open");
                        _slideDown(this.closest(".filter__item").querySelector(".dropdown-filter"), 150);
                    } else {
                        this.closest(".filter-js-item").classList.remove("filter-open");
            ...
            document.addEventListener("click", (function(e) {
                const el = e.target;
                if (!el.closest(".filter-js-item")) filterItem.forEach((element => {
                    element.classList.remove("filter-open");
                    _slideUp(element.querySelector(".dropdown-filter"), 150);
                }));
            }));
        }
        const currencyItem = document.querySelectorAll(".filter-currency__item");
        currencyItem.forEach((element => {
            element.addEventListener("click", (function(e) {
                currencyItem.forEach((el => {
                    el.classList.remove("filter-currency__current");
                }));
